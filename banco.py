...
def menu() -> None:
    ...
    print('4- Efetuar transfereência')
...
def efetuar_saque() -> None:
    if len(contas) > 0:
        ...
        if conta:
            ...
            print(f'Não foi encontrada a conta com o número {numero} informado.')
    else:
    ...
    if len(contas) > 0:
        ...
        if conta_o:
            ...
            if conta_d:
                ...
                print(f'A conta de destino do número {numero_d} não foi encontrada.')
        else:
            print(f'A sua conta com númerp {numero_o} não foi encontrada.')
    else:
        print('Ainda não há contas cadastradas.')
    sleep(2)
    menu()
